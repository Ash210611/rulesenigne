...
from un_re.get_antlr_findings import get_antlr_findings
...
# ===============================================================================
def get_esp_antlr_findings(file_num):
    ...
    get_antlr_findings(G.ANTLR_LOG_FILENAME)


# ===============================================================================
def get_regular_antlr_findings(file_num):
...
def get_td_antlr_findings():
    ...
    for G.FILE_NUM in range(len(G.FILE_DICT)):
        ...
        if G.RULES_ENGINE_TYPE == 'ESP_RE':
            get_esp_antlr_findings(G.FILE_NUM)

        else:
            get_regular_antlr_findings(G.FILE_NUM)
